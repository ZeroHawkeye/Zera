...
This will generate corresponding code under the `backend/gen/` and `frontend/src/gen/` directories.

Create handlers under the `backend/internal/handler/` directory:
...
Please provide the MDX content you would like me to translate from Chinese (Simplified) to English.
