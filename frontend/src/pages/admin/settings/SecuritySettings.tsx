...
import { Card, Form, InputNumber, Button, Switch, Skeleton, message, Alert, theme } from 'antd'
  ...
  useEffect(() => {
    if (data?.settings?.security) {
      form.setFieldsValue({
        ...
        passwordRequireUppercase: data.settings.security.passwordRequireUppercase ?? true,
        passwordRequireNumber: data.settings.security.passwordRequireNumber ?? true,
        passwordRequireSpecial: data.settings.security.passwordRequireSpecial ?? false,
      })
    }
  }, [data, form])
            ...
            <>
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <Form.Item name="passwordRequireUppercase" valuePropName="checked" className="mb-0">
                ...
                >
                  ...
                  <Form.Item name="passwordRequireNumber" valuePropName="checked" className="mb-0">
                    <Switch className="flex-shrink-0" />
                  </Form.Item>
                </div>
                ...
                >
                  ...
                  <Form.Item name="passwordRequireSpecial" valuePropName="checked" className="mb-0">
                    <Switch className="flex-shrink-0" />
                  </Form.Item>
                </div>
              </div>
